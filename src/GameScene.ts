...
class GameScene extends GameUtil.BassPanel
{
    ...
    private showgamebg()
    {
       ...
       // this.playerrole = new RoleSprite(RES.getRes('shopself_'+GameData._i().PlayerRoleType+'_png'),this.mStageW/2,this.mStageH/2);
        ...
        var rolecontrolimg: Dircontorllayer = new Dircontorllayer(RES.getRes('roleControlimg_png'),this.mStageW/2,1120,-1,this.playerrole);
        this.addChild(rolecontrolimg);
        var dirpos: number[][] = [[375,1000],[500,1120],[375,1240],[254,1120],[375,1120]];
        ...
        var putbombtn: Dircontorllayer = new Dircontorllayer(RES.getRes('putbombtn_png'),this.mStageW/2,1120,4,this.playerrole);
